...
- `@theia/core/electron-shared/...`
  ...
  - `electron` (from [`electron@37.2.4`](https://www.npmjs.com/package/electron/v/37.2.4))
...
- `@theia/core/shared/...`
  ...
  - `@theia/application-package` (from [`@theia/application-package@1.64.0`](https://www.npmjs.com/package/@theia/application-package/v/1.64.0))
  - `@theia/application-package/lib/api` (from [`@theia/application-package@1.64.0`](https://www.npmjs.com/package/@theia/application-package/v/1.64.0))
  - `@theia/application-package/lib/environment` (from [`@theia/application-package@1.64.0`](https://www.npmjs.com/package/@theia/application-package/v/1.64.0))
  - `@theia/request` (from [`@theia/request@1.64.0`](https://www.npmjs.com/package/@theia/request/v/1.64.0))
  - `@theia/request/lib/proxy` (from [`@theia/request@1.64.0`](https://www.npmjs.com/package/@theia/request/v/1.64.0))
  - `@theia/request/lib/node-request-service` (from [`@theia/request@1.64.0`](https://www.npmjs.com/package/@theia/request/v/1.64.0))
