...
- `@theia/core/shared/...`
  ...
  - `@theia/application-package` (from [`@theia/application-package@1.65.1`](https://www.npmjs.com/package/@theia/application-package/v/1.65.1))
  - `@theia/application-package/lib/api` (from [`@theia/application-package@1.65.1`](https://www.npmjs.com/package/@theia/application-package/v/1.65.1))
  - `@theia/application-package/lib/environment` (from [`@theia/application-package@1.65.1`](https://www.npmjs.com/package/@theia/application-package/v/1.65.1))
  - `@theia/request` (from [`@theia/request@1.65.1`](https://www.npmjs.com/package/@theia/request/v/1.65.1))
  - `@theia/request/lib/proxy` (from [`@theia/request@1.65.1`](https://www.npmjs.com/package/@theia/request/v/1.65.1))
  - `@theia/request/lib/node-request-service` (from [`@theia/request@1.65.1`](https://www.npmjs.com/package/@theia/request/v/1.65.1))
